...
class MqttGatewayServiceFactory extends pip_services_components_node_1.Factory {
    constructor() {
        super();
...
MqttGatewayServiceFactory.Descriptor = new pip_services_commons_node_1.Descriptor("iqs-services-mqttgateway", "factory", "default", "default", "1.0");
MqttGatewayServiceFactory.ConnectorDescriptor = new pip_services_commons_node_1.Descriptor("iqs-services-mqttgateway", "connector", "default", "*", "1.0");
MqttGatewayServiceFactory.ControllerDescriptor = new pip_services_commons_node_1.Descriptor("iqs-services-mqttgateway", "controller", "default", "*", "1.0");
MqttGatewayServiceFactory.HttpServiceDescriptor = new pip_services_commons_node_1.Descriptor("iqs-services-mqttgateway", "service", "http", "*", "1.0");
